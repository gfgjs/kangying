	...
	<view>
		...
		<view class="header linear-background">
			<view class="head-wrap" @click="clickHead">
				...
				<view v-else>点此登录</view>
			</view>
		</view>
		<view class="footer">
			<view class="recoder">
				<view class="title" @click="pageTo('/pages/mall/order',0)">药品订单</view>
				<view class="buttons">
			...
			<view class="wrap img-menu">
				...
				<view class="item" @click="pageTo('/pages/doctor/case',0)">
					<view class="title">
						健康档案
						<uni-icons type="arrowright"></uni-icons>
					</view>
			...
			<view class="wrap menu">
				<view class="row">
					...
					<view class="buttons">
						...
						<view class="item" @click="pageTo('/pages/doctor/case',1)">
							<image src="../../static/mine/9.png" mode=""></image>
							<view>我的挂号</view>
						</view>
						<view class="item" @click="pageTo('/pages/doctor/case',2)">
							<image src="../../static/mine/10.png" mode=""></image>
							<view>电子处方</view>
						</view>
						<view class="item" @click="pageTo('/pages/doctor/case',3)">
				...
				<view class="row">
					...
					<view class="buttons">
						...
						<view class="item" @click="pageTo('/pages/mine/feedback')">
