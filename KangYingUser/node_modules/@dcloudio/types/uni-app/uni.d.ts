declare namespace UniApp {
    interface Uni {
         ...
         * 创建 canvas 绘图上下文
         *
         * 文档: [http://uniapp.dcloud.io/api/ui/canvas?id=createcanvascontext](http://uniapp.dcloud.io/api/ui/canvas?id=createcanvascontext)
         */
        ...
        /**
         *
         * 创建激励视频广告组件。请通过 [uni.getSystemInfoSync()](https://developers.weixin.qq.com/miniprogram/dev/api/base/system/system-info/wx.getSystemInfoSync.html) 返回对象的 SDKVersion 判断基础库版本号后再使用该 API（小游戏端要求 >= 2.0.4， 小程序端要求 >= 2.6.0）。调用该方法创建的激励视频广告是一个单例（小游戏端是全局单例，小程序端是页面内单例，在小程序端的单例对象不允许跨页面使用）。
         *
         * 最低基础库： `2.0.4`
         *
         * 文档: [https://developers.weixin.qq.com/miniprogram/dev/api/ad/wx.createRewardedVideoAd.html](https://developers.weixin.qq.com/miniprogram/dev/api/ad/wx.createRewardedVideoAd.html)
         */
         ...
         * 最低基础库： `2.10.3`
         *
         * 文档: [https://developers.weixin.qq.com/miniprogram/dev/api/device/bluetooth/wx.offBLEPeripheralConnectionStateChanged.html](https://developers.weixin.qq.com/miniprogram/dev/api/device/bluetooth/wx.offBLEPeripheralConnectionStateChanged.html)
         */
         ...
         * 最低基础库： `2.9.2`
         *
         * 文档: [https://developers.weixin.qq.com/miniprogram/dev/aapi/ui/keyboard/wx.offKeyboardHeightChange.html](https://developers.weixin.qq.com/miniprogram/dev/aapi/ui/keyboard/wx.offKeyboardHeightChange.html)
         */
        offKeyboardHeightChange(callback: (...args: any[]) => any): void;
        /**
         *
         * 取消监听 mDNS 服务停止搜索的事件
         *
         ...
         * 最低基础库： `2.9.3`
         *
         * 文档: [https://developers.weixin.qq.com/miniprogram/dev/api/device/network/wx.offNetworkStatusChange.html](https://developers.weixin.qq.com/miniprogram/dev/api/device/network/wx.offNetworkStatusChange.html)
         */
        offNetworkStatusChange(callback: (...args: any[]) => any): void;
        /**
         *
         * 取消监听小程序要打开的页面不存在事件
         *
         ...
         * 最低基础库： `2.10.3`
         *
         * 文档: [https://developers.weixin.qq.com/miniprogram/dev/api/device/bluetooth/wx.onBLEPeripheralConnectionStateChanged.html](https://developers.weixin.qq.com/miniprogram/dev/api/device/bluetooth/wx.onBLEPeripheralConnectionStateChanged.html)
         */
    ...
    interface InterstitialAd {
         ...
         */
        offClose(callback: UDPSocketOffCloseCallback): void;
        /**
         *
         * 取消监听插屏错误事件
         *
         ...
         */
        offError(callback: InterstitialAdOffErrorCallback): void;
        /**
         *
         * 取消监听插屏广告加载事件
         *
    ...
    interface RewardedVideoAd {
         ...
         * 加载激励视频广告。
         *
         * 文档: [https://developers.weixin.qq.com/miniprogram/dev/api/ad/RewardedVideoAd.load.html](https://developers.weixin.qq.com/miniprogram/dev/api/ad/RewardedVideoAd.load.html)
         */
        load(): Promise<any>;
        /**
         *
         ...
         *
         * 文档: [https://developers.weixin.qq.com/miniprogram/dev/api/ad/RewardedVideoAd.show.html](https://developers.weixin.qq.com/miniprogram/dev/api/ad/RewardedVideoAd.show.html)
         */
        show(): Promise<any>;
        /**
         *
         ...
         * 最低基础库： `2.8.0`
         *
         * 文档: [https://developers.weixin.qq.com/miniprogram/dev/api/ad/RewardedVideoAd.destroy.html](https://developers.weixin.qq.com/miniprogram/dev/api/ad/RewardedVideoAd.destroy.html)
         */
        destroy(): void;
        /**
         *
         * 取消监听用户点击 `关闭广告` 按钮的事件
         *
         * 文档: [https://developers.weixin.qq.com/miniprogram/dev/api/ad/RewardedVideoAd.offClose.html](https://developers.weixin.qq.com/miniprogram/dev/api/ad/RewardedVideoAd.offClose.html)
         */
        offClose(callback: RewardedVideoAdOffCloseCallback): void;
        /**
         *
         * 取消监听激励视频错误事件
         *
         * 文档: [https://developers.weixin.qq.com/miniprogram/dev/api/ad/RewardedVideoAd.offError.html](https://developers.weixin.qq.com/miniprogram/dev/api/ad/RewardedVideoAd.offError.html)
         */
        offError(callback: RewardedVideoAdOffErrorCallback): void;
        /**
         *
         * 取消监听激励视频广告加载事件
         *
         * 文档: [https://developers.weixin.qq.com/miniprogram/dev/api/ad/RewardedVideoAd.offLoad.html](https://developers.weixin.qq.com/miniprogram/dev/api/ad/RewardedVideoAd.offLoad.html)
         */
        offLoad(callback: OffLoadCallback): void;
        /**
         *
         * 监听用户点击 `关闭广告` 按钮的事件。
         *
         * 文档: [https://developers.weixin.qq.com/miniprogram/dev/api/ad/RewardedVideoAd.onClose.html](https://developers.weixin.qq.com/miniprogram/dev/api/ad/RewardedVideoAd.onClose.html)
         */
        onClose(callback: RewardedVideoAdOnCloseCallback): void;
        /**
         *
         * 监听激励视频错误事件。
         *
         ...
         * | 1008  | 广告单元已关闭  | 该广告位的广告能力已经被关闭 | 请前往mp.weixin.qq.com重新打开对应广告位的展现。|
         *
         * 文档: [https://developers.weixin.qq.com/miniprogram/dev/api/ad/RewardedVideoAd.onError.html](https://developers.weixin.qq.com/miniprogram/dev/api/ad/RewardedVideoAd.onError.html)
         */
        onError(callback: RewardedVideoAdOnErrorCallback): void;
        /**
         *
         * 监听激励视频广告加载事件。
         *
         * 文档: [https://developers.weixin.qq.com/miniprogram/dev/api/ad/RewardedVideoAd.onLoad.html](https://developers.weixin.qq.com/miniprogram/dev/api/ad/RewardedVideoAd.onLoad.html)
         */
        onLoad(callback: OnLoadCallback): void;
    }
    ...
    interface UDPSocket {
         ...
         */
        offError(callback: UDPSocketOffErrorCallback): void;
        /**
         *
         * 取消监听开始监听数据包消息的事件
         *
    ...
    interface VideoDecoder {
         ...
         */
        getFrameData(): Record<string, any>;
        /**
         *
         * 取消监听录制事件。当对应事件触发时，该回调函数不再执行
         *
         ...
         */
        on(eventName: "start" | "stop" | "seek", callback: (...args: any[]) => any): void;
        /**
         *
         * 移除解码器
         *
    ...
    interface BLEPeripheralServer {
         ...
         * 最低基础库： `2.10.3`
         *
         * 文档: [https://developers.weixin.qq.com/miniprogram/dev/api/device/bluetooth/BLEPeripheralServer.addService.html](https://developers.weixin.qq.com/miniprogram/dev/api/device/bluetooth/BLEPeripheralServer.addService.html)
         */
         ...
         * 最低基础库： `2.10.3`
         *
         * 文档: [https://developers.weixin.qq.com/miniprogram/dev/api/device/bluetooth/BLEPeripheralServer.close.html](https://developers.weixin.qq.com/miniprogram/dev/api/device/bluetooth/BLEPeripheralServer.close.html)
         */
         ...
         * 最低基础库： `2.10.3`
         *
         * 文档: [https://developers.weixin.qq.com/miniprogram/dev/api/device/bluetooth/BLEPeripheralServer.removeService.html](https://developers.weixin.qq.com/miniprogram/dev/api/device/bluetooth/BLEPeripheralServer.removeService.html)
         */
         ...
         * 最低基础库： `2.10.3`
         *
         * 文档: [https://developers.weixin.qq.com/miniprogram/dev/api/device/bluetooth/BLEPeripheralServer.startAdvertising.html](https://developers.weixin.qq.com/miniprogram/dev/api/device/bluetooth/BLEPeripheralServer.startAdvertising.html)
         */
         ...
         * 最低基础库： `2.10.3`
         *
         * 文档: [https://developers.weixin.qq.com/miniprogram/dev/api/device/bluetooth/BLEPeripheralServer.stopAdvertising.html](https://developers.weixin.qq.com/miniprogram/dev/api/device/bluetooth/BLEPeripheralServer.stopAdvertising.html)
         */
         ...
         * 最低基础库： `2.10.3`
         *
         * 文档: [https://developers.weixin.qq.com/miniprogram/dev/api/device/bluetooth/BLEPeripheralServer.writeCharacteristicValue.html](https://developers.weixin.qq.com/miniprogram/dev/api/device/bluetooth/BLEPeripheralServer.writeCharacteristicValue.html)
         */
    ...
    interface CreateBLEPeripheralServerSuccessCallbackResult {
         ...
         * 外围设备的服务端。
         *
         * 文档: [https://developers.weixin.qq.com/miniprogram/dev/api/device/bluetooth/BLEPeripheralServer.html](https://developers.weixin.qq.com/miniprogram/dev/api/device/bluetooth/BLEPeripheralServer.html)
         */
