<template>
    <div class="app-container">
        ...
        >
            ...
            <el-table-column label="就诊卡数量" width="150px" align="flex-start">
                <template slot-scope="{row}">
                    <span>{{ row.pcard_count }}</span>
                </template>
            </el-table-column>
            ...
            <el-table-column label="最近登录时间" width="110px" align="center">
                <template slot-scope="{row}">
...
import { getHospitalList, getUserList } from '@/api/kangying-https'
