<template>
    <div class="app-container">
        ...
        >
            ...
            <el-table-column label="医院" min-width="150px" align="flex-start">
                <template slot-scope="{row}">
...
import { getHospitalList, getPesList, getRecordsList } from '@/api/kangying-https'
...
export default {
    ...
    methods: {
        ...
        getList() {
            ...
            getPesList(this.listQuery).then(res => {
