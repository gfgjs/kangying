    ...
    <div class="app-container">
        ...
        >
            ...
            <el-table-column label="缩略图" prop="id" align="center" width="200px">
                <template slot-scope="{row}">
                    <img :src="row.article_thumb" style="max-height: 100px;max-width: 100px;" alt="">
                </template>
            </el-table-column>
            <el-table-column label="文章标题" width="150px" align="center">
                <template slot-scope="{row}">
            ...
            <el-table-column label="是否禁用" width="150px" align="center">
                <template slot-scope="{row}">
                    <span>{{ row.is_delete ?'是':'否' }}</span>
                </template>
            </el-table-column>
        ...
        <el-dialog fullscreen :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            ...
            >
                ...
                <el-form-item style="width: 20%;" label="套餐名" prop="title">
                    <el-input v-model="temp.article_title"/>
                </el-form-item>
                <el-form-item>
                    <img :src="temp.article_thumb" alt="" style="max-width: 100px;max-height: 100px;">
                    <el-upload
                        class="upload-demo"
                ...
                <el-form-item style="width: 100%;">
                    <tinymce :height="500" style="width: 80%;" v-model="temp.article_content" id='tinymce-ky'></tinymce>
                </el-form-item>
...
import {
    adminArticleDel,
    adminArticleList, adminArticleSave,
    adminPeDel,
    adminPeList,
    adminPeSave,
    getHospitalList,
...
export default {
    ...
    methods: {
        imgUploadSuccess(res) {
            this.temp.article_thumb = res.data
        },
        ...
        viewHospitalDetails(row) {
            this.$router.push({
                ...
                query: { desc: row.article_content }
            })
        },
        getList() {
            this.listLoading = true
            adminArticleList(this.listQuery).then(res => {
        ...
        createData() {
            ...
            adminArticleSave(this.temp).then(res => {
                if (res.code === '000') {
