<template>
  <div class="app-container">
    ...
    >
      <el-table-column label="医院序号" prop="id" align="center" width="100px">
      ...
      <el-table-column label="医院级别" width="150px">
        <template slot-scope="{row}">
          <span>{{ row.hospital_level }}</span>
          <!--                    <el-tag>{{ row.type | typeFilter }}</el-tag>-->
        </template>
      </el-table-column>
      <el-table-column label="地址" min-width="150px" align="flex-start">
        <template slot-scope="{row}">
...
import { getHospitalList } from '@/api/kangying-https'
