<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="所属医院" width="150px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.hospital_name }}</span>
        </template>
      </el-table-column>
      <el-table-column label="医生姓名" width="150px">
        <template slot-scope="{row}">
          <span>{{ row.user_name }}</span>
          <!--                    <el-tag>{{ row.type | typeFilter }}</el-tag>-->
        </template>
      </el-table-column>
      <el-table-column label="职称" min-width="150px" align="flex-start">
        <template slot-scope="{row}">
          <span>{{ row.level_name }}</span>
        </template>
      </el-table-column>
      <el-table-column label="擅长项目" min-width="150px" align="flex-start">
        <template slot-scope="{row}">
...
import { getDoctorList, getHospitalList, getUserList } from '@/api/kangying-https'
